...
$CONFIG['db_user'] ='root';
$CONFIG['db_password'] ='';
$CONFIG['db_name'] ='resturant';
$CONFIG['base_url'] ='http://localhost/offerplant/';
...
$CONFIG['month_list'] = array('April','May','June','July','August','September','October','November','December','January','February','March');
	
$CONFIG['state_list'] = array('Bihar','Assam','Chhattisgarh','Kerala','Maharashtra','Manipur ','Meghalaya');
